...
but hard-constrained to pass through real, cited checkpoints (CAG audit
percentages, the real Sarguja/Pilibhit 2023-24 TB stockout dates and
figures). See `docs/DATA_SOURCES.md` for the full audit trail.
...
python scripts/fetch_facilities_osm.py      # real facilities (OpenStreetMap)
python scripts/build_facility_registry.py
